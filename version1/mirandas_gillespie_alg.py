...
while t < t_max:
   ...
   #propensities
   a_prod = k_prod
   a_deg = k_deg * x #scales with how many molecules exist
   ...
   if rng.random() < a_prod / a_total:
       x = x+1 #production fired
   else:
       x = x-1 # degradation fired
   ...
   counts.append(x) #add new molecule count to history list
